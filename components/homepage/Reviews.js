...
function Reviews() {
  ...
  return (
    <div className={styles.Reviews}>
      <div className={styles.Container} id='reviews' ref={el}>
      <div className={styles.Title}>
        ...
        <div className={styles.Testimonies}>
          ...
          whileHover={{
            ...
            <StarPurple500SharpIcon className={styles.Icon} />
            <StarPurple500SharpIcon className={styles.Icon} />
            <StarHalfSharpIcon className={styles.Icon} />
            </div>
          ...
          whileHover={{
            ...
            <div className={styles.Center}>
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor quidem ut at dolore dolores numquam eaque molestiae repellat voluptate atque?</p>
            </div>
            <div className={styles.Bottom}>
              <h4>Paul Mkina</h4>
          ...
          whileHover={{
            ...
            <div className={styles.Center}>
              <h3>Lorem, ipsum dolor sit amet consectetur adipisicing.</h3>
              <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Itaque culpa neque nihil porro voluptatibus, doloremque iusto aliquam excepturi placeat unde est qui possimus voluptatum voluptatem non minus harum laudantium dicta aut obcaecati impedit esse adipisci. Placeat fugit fuga, necessitatibus perferendis architecto ab. Eligendi, aliquid quas.</p>
            </div>
            <div className={styles.Bottom}>
              <h4>Angela Benson</h4>
              <p>Business Owner</p>

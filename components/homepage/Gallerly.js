...
function Gallerly() {
  ...
  return (
    ...
    <Image className={styles.Image2__border} src={img3} layout='fill' objectFit='cover' alt=''></Image>
    </div>
    <div className={styles.Image3} id='image3'>
    <Image className={styles.Image3__border} src={img2} layout='fill' objectFit='cover' alt=''></Image>
    </div>
    <div className={styles.Image4} id='image4'>
    <Image className={styles.Image4__border} src={img3} layout='fill' objectFit='cover' alt=''></Image>
    </div>

...
function EventReviews() {
  ...
  return (
    <div className={styles.EventReviews}>
      <div className={styles.Container} id='event-reviews' ref={el}>
        ...
        <div className={styles.Testimonies}>
          ...
          whileHover={{
            ...
            <div className={styles.Center}>
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam odio quos repellendus aliquam cumque eum vitae ullam tempore veritatis?</p>
            </div>
            <div className={styles.Bottom}>
          ...
          whileHover={{
            ...
            <div className={styles.Center}>
              <h3>Lorem, ipsum dolor sit amet consectetur adipisicing.</h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam odio quos repellendus aliquam cumque eum vitae ullam tempore veritatis. Non earum ducimus expedita incidunt?</p>
            </div>
            <div className={styles.Bottom}>
              <h4>Angela Benson</h4>
              <p>Business Owner</p>
